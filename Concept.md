...
Things are a bit different than expectations...

## Liquid Lens

For my lenses are not bound to a minimum curvature, it can transition from a convex lens all the way to a concave lens, potentially reversing the effort to magnify objects.
Instead of using electricity to manipulate the pressure, I chose to control mechanically with a syringe.
...
alright there you go, the concept of my project! see you in the other documents!
